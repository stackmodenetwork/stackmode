      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {features.map((f, i) => (
            ...
            >
              <h3 className="text-lg tracking-[0.15em] mb-3 transition-colors group-hover:text-[#00E5FF]" style={{ fontFamily: "'Bebas Neue', sans-serif", color: 'rgba(255,255,255,0.8)' }}>
                {f.title}
              </h3>
        ...
        <div className={`rounded-lg border overflow-hidden transition-all duration-700 delay-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          ...
          {/* Browser chrome */}
          <div className="flex items-center gap-2 px-4 py-3 border-b" style={{ borderColor: 'rgba(0,229,255,0.1)', background: 'rgba(0,229,255,0.02)' }}>
          ...
          {/* Preview area */}
          <div className="h-48 sm:h-64 md:h-80 relative" style={{ background: 'linear-gradient(135deg, #030305 0%, rgba(0,229,255,0.03) 50%, #030305 100%)' }}>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl tracking-[0.2em] mb-2" style={{ fontFamily: "'Bebas Neue', sans-serif", color: '#00E5FF40' }}>
                  YOUR SITE HERE
                </div>

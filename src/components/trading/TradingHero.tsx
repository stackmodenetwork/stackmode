...
export const TradingHero = () => {
  return (
    <section className="relative z-10 px-4 pt-8 pb-12 sm:pt-12 sm:pb-16">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Hook Line */}
        <motion.p
          className="text-base sm:text-lg text-foreground/80 font-medium italic"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}

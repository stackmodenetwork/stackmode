    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-4">
          <a href="https://discord.gg/5zYWSWGMYm" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Discord">
      ...
      <div className="flex flex-wrap justify-center gap-4 text-xs text-muted-foreground mb-4">
        ...
        <a href="https://ceoturbo.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors">CEOTurbo.com</a>
      </div>

        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              <a
                href="/trading"
                className="inline-flex items-center gap-1 bg-emerald-500 hover:bg-emerald-400 text-background font-bold px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-lg transition-all text-xs sm:text-sm">
                <span className="hidden sm:inline">Get Trading Education</span>
                <span className="sm:hidden">Trading</span>
              </a>
              <a
                href="/shop"
                className="inline-flex items-center gap-1 bg-cyan-500 hover:bg-cyan-400 text-background font-bold px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-lg transition-all text-xs sm:text-sm">
      ...
      <footer className="bg-background border-t border-border/50 py-6 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xs text-muted-foreground mb-3">
            Grow your brand beyond code → <a href="https://ceoturbo.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 font-medium">CEOTurbo.com</a>
          </p>

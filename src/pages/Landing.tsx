...
const Landing = () => (
  <div className="relative" style={{ background: '#04040a' }}>
    <Helmet>
      ...
      <meta name="description" content="Stackmode Academy — founded by Christopher Robinson (StackmodeChris). Learn AI tools, software development, Python coding, stock trading, and investing in one complete ecosystem. Code. Content. Capital. Join for $50/month at stackmode.net" />
      <meta name="keywords" content="stackmode academy, stackmodechris, christopher robinson CEO, learn AI online, coding and trading school, software development course, AI tools for beginners, python programming course, stock trading school, crypto investing course, learn to code and trade, digital assets course, build passive income online, web development bootcamp, content monetization, financial freedom course, online tech school, CEO turbo, NFC digital business cards, brand boost, Atlanta Georgia tech school, christopherrobinsonceo instagram, stackmodechris tiktok, ChristopherRobinson-CEO youtube" />

...
const Coding = () => {
  return (
    <main className="min-h-screen bg-background">
      <Helmet>
        <title>Build Software. Sell Software. | Stackmode Coding School</title>
        <meta name="description" content="Learn to code with AI tools. No degree needed. Build real apps that make money." />
      </Helmet>
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center px-4 py-12 sm:py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Build Software. <span className="text-cyan-400">Sell Software.</span>
          </motion.h1>
          ...
          >
            Learn to code with AI tools. No degree needed. Build real apps that make money.
          </motion.p>
          ...
          <ScrollReveal>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { emoji: '🏢', name: 'Business Tools' },
                { emoji: '🤖', name: 'AI Chatbots' },

...
import { ShoppingCart, Briefcase, Play, BookOpen, CandlestickChart, Siren, Check } from 'lucide-react';
const Index = () => {
  ...
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <AnimatedBlock delay={0.05} className="text-center mb-4 mt-8">
          <img 
            src="/lovable-uploads/a7f33c6f-a4f7-43b7-a338-1d28936d1ac0.png" 
            alt="StackMode Logo" 
            className="w-24 h-24 mx-auto mb-6 rounded-lg shadow-[0_0_30px_rgba(34,197,94,0.6)] hover:shadow-[0_0_50px_rgba(34,197,94,0.8)] transition-all duration-500 animate-float"
          />
        </AnimatedBlock>

        {/* Title Block */}
        <AnimatedBlock delay={0.1} className="text-center mb-8">
        ...
        <AnimatedBlock delay={1.17} className="mb-16 text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-accent neon-glow">$3000+</div>

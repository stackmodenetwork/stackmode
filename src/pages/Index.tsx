      ...
      <section id="home" className="relative z-10 min-h-screen px-4 py-6 sm:py-8">
        ...
        <AnimatedBlock delay={1.175} className="mb-16">
          <div id="courses" className="max-w-md mx-auto px-4 scroll-mt-20">
            <a href="https://rss.com/podcasts/the-stackmode-network-with-stackmodechris-stackmodenet/?listen-on=true" target="_blank" rel="noopener noreferrer" className="group relative block">

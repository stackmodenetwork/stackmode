        ...
        <div className="mb-16 space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <AnimatedBlock delay={0.9} className="w-80 h-16">
              <a href="https://rss.com/podcasts/stacktalk-with-stackmodechris/" target="_blank" rel="noopener noreferrer" className="w-full h-full bg-card neon-border rounded flex items-center justify-center hover:bg-card/80 hover:soft-glow transition-all cursor-pointer">
                <Mic size={24} className="text-cyan-400 mr-3 neon-glow" />
                <span className="text-foreground font-bold tracking-wider">STACKTALK PODCAST</span>
              </a>
            </AnimatedBlock>

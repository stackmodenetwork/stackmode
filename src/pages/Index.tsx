            ...
            <a href="https://calendly.com/stackmodechris/tradingmastermindcoaching" target="_blank" rel="noopener noreferrer" className="block group h-full">
              <div className="relative h-full bg-gradient-to-br from-card/80 via-card/60 to-card/80 border-2 border-accent/50 rounded-2xl p-8 overflow-hidden transition-all duration-500 hover:border-accent hover:shadow-[0_0_60px_rgba(var(--accent-rgb),0.4)] group-hover:scale-[1.02]">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-foreground/80 mb-6 text-center text-xs md:text-sm italic">One-on-one guidance tailored to your trading goals — spots available, limited!</p>
            ...
            <a href="https://discord.gg/stackmodechris" target="_blank" rel="noopener noreferrer" className="group relative">
              <div className="relative overflow-hidden bg-card/50 backdrop-blur-sm border border-primary/30 rounded-xl p-6 hover:border-primary transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/20">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-lg font-bold text-foreground mb-1">JOIN DISCORD</h3>
            ...
            <a href="https://podcasters.spotify.com/pod/show/stackmodechris" target="_blank" rel="noopener noreferrer" className="group relative">
              <div className="relative overflow-hidden bg-card/50 backdrop-blur-sm border border-accent/30 rounded-xl p-6 hover:border-accent transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-accent/20">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-lg font-bold text-foreground mb-1">LISTEN TO PODCAST</h3>

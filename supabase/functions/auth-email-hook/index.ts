...
const SENDER_DOMAIN = "notify.stackmode.net"
const ROOT_DOMAIN = "stackmode.net"
const FROM_DOMAIN = "stackmode.net" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://stackmode.lovable.app"
